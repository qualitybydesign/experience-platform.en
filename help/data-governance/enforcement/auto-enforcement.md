...
>[!NOTE]
>
>If there are data usage labels that have only been applied to certain fields, enforcement of those field-level labels on activation only occurs only if at least one of the following conditions are met:
>
